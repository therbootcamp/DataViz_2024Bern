...
<ul>
  <li class="m1"><span>Set <high> global settings for all chunks</high> in the YAML header.</span></li>
  <li class="m2"><span>All chunk options can be used.</span></li>
</ul>
...
<ul>
  <li class="m1"><span>Load packages and data inthe initial chunk.</span></li>
  <li class="m2"><span>Additional global behavior is set in the YAML header.</span></li>
</ul>
