...
In this practical, you will [**recreate this html report**](Report2.html).   

### 0 - Preliminaries

1. We will continue adapting the document you produced in the last session. 

2. Create a header at the third level (`###`) with the title `The Gini Coefficient`. 

3. Add the following text:

```{}
It measures inequality on a scale from 0 to 1, where higher values indicate higher inequality. This can sometimes be shown as a percentage from 0 to 100%, called the “Gini Coefficient”. A value of 0 indicates perfect equality: everyone has the same income.
```

### 1 - Add a Table of contents

1. Add the following code to show a Table of Contents
...
2. Move Table of Contents to the left
...
### 3 - Add a table showing data for St. Alban
