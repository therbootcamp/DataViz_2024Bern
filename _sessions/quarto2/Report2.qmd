...
The data contains information on the wealth and income of the inhabitants of the `r length(unique(basel$quarter))` quarters of Basel, which was determined from tax-return documents. The data was provided by [Open Data Basel](https://www.opendata.bs.ch/). Figure  @fig-gini presents a schematic overview of the data. 
