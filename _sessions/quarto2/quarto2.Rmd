...
.pull-left4[
Quarto supports different presentation formats:
<ul>
  <li class="m1"><span>HTML with reveal.js</span></li> 
  <li class="m2"><span>Powerpoint with MS Office</span></li>
    <li class="m3"><span>LaTeX with Beamer</span></li>
</ul>
...
<iframe class="slide-deck" src="example_presentations/turn_on.html" width = "60%" ></iframe>
...
<high>Rendering</high> (translating) your .qmd file into the <high>final format</high>: 
<ul>
